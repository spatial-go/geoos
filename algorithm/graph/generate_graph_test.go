...
func TestIntersectionHandle(t *testing.T) {
	...
	testMatrix := []args{
		...
		{"matrix poly", matrix.Matrix{100, 100}, matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}},
			&MatrixGraph{nodes: []*Node{{Index: 0, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}}, edges: []map[int]int{{}}},
			&MatrixGraph{nodes: []*Node{{Index: 0, Stat: true, inGraph: true, NodeType: ANode, Value: matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}},
				edges: []map[int]int{{1: PointPoly}, {0: PointPoly}}},
		},

		{"line matrix", matrix.LineMatrix{{100, 100}, {100, 200}}, matrix.Matrix{100, 100},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}},
				edges: []map[int]int{{1: PointLine}, {0: PointLine}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}}, edges: []map[int]int{{}}},
		},
		{"line line", matrix.LineMatrix{{100, 100}, {100, 202}}, matrix.LineMatrix{{100, 100}, {100, 200}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: false, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 202}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}},
				{Index: 2, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 3, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 200}},
				{Index: 4, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 200}, {100, 202}}},
			}, edges: []map[int]int{{}, {2: PointLine}, {1: PointLine, 3: PointLine}, {2: PointLine, 4: PointLine}, {3: PointLine}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}},
				{Index: 2, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 200}}},
		...
		{"line poly", matrix.LineMatrix{{100, 100}, {100, 200}}, matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}},
			&MatrixGraph{nodes: []*Node{
				...
				edges: []map[int]int{{1: PointLine, 2: PointLine}, {0: PointLine}, {0: PointLine}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: false, inGraph: true, NodeType: ANode, Value: matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}},
				{Index: 2, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 3, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 200}},
				{Index: 4, Stat: true, inGraph: true, NodeType: CNode, Value: matrix.LineMatrix{{100, 200}, {200, 200}, {200, 100}, {100, 100}}},
			},
		...
		{"poly matrix", matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}, matrix.Matrix{100, 100},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: ANode, Value: matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}},
				edges: []map[int]int{{1: PointPoly}, {0: PointPoly}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}}},
				edges: []map[int]int{{}}},
		},
		{"poly line", matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}, matrix.LineMatrix{{100, 100}, {100, 200}},
			&MatrixGraph{nodes: []*Node{
				...
				{Index: 2, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 3, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 200}},
				{Index: 4, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 200}, {200, 200}, {200, 100}, {100, 100}}}},
				edges: []map[int]int{{}, {2: PointLine, 4: PointLine}, {1: PointLine, 3: PointLine}, {2: PointLine, 4: PointLine}, {1: PointLine, 3: PointLine}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: LNode, Value: matrix.LineMatrix{{100, 100}, {100, 200}}},
				{Index: 1, Stat: true, inGraph: true, NodeType: PNode, Value: matrix.Matrix{100, 100}},
		...
		{"poly poly", matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}},
			matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}},
			&MatrixGraph{nodes: []*Node{
				{Index: 0, Stat: true, inGraph: true, NodeType: ANode, Value: matrix.PolygonMatrix{{{100, 100}, {100, 200}, {200, 200}, {200, 100}, {100, 100}}}}},
				edges: []map[int]int{{}}},
			&MatrixGraph{nodes: []*Node{
