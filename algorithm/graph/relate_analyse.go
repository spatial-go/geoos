...
func (r *Relationship) lineAnalyse(pointInPolygon, entityInPolygon int) {
	switch r.Arg[1].(type) {
	case matrix.LineMatrix:
		...
		case r.pNum == 1 && r.lNum == 0 && r.maxDlPoint == 2:
			r.relationshipSymbol = RLL21

		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 3 && r.sumDlPoint >= 6:
			if r.cNum == 1 {
		...
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 3 && r.sumDlPoint == 5:
			r.relationshipSymbol = RLL27
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4:
			r.relationshipSymbol = RLL6
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 2:
			r.relationshipSymbol = RLL20
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4:
			r.relationshipSymbol = RLL23

		case r.pNum == 3 && r.lNum == 0 && r.maxDlPoint == 4 && r.sumDlPoint == 8:
			r.relationshipSymbol = RLL22
		case r.pNum == 3 && r.lNum == 0 && r.maxDlPoint == 4 && r.sumDlPoint == 9:
			r.relationshipSymbol = RLL28
		case r.pNum == 3 && r.lNum == 0 && r.maxDlPoint == 4:
			if true {
				r.relationshipSymbol = RLL7
			} else {
				r.relationshipSymbol = RLL15
			}
		case r.pNum == 3 && r.lNum == 0 && r.maxDlPoint == 3 && r.sumDlPoint >= 9:
			r.relationshipSymbol = RLL13
		case r.pNum == 3 && r.lNum == 0 && r.maxDlPoint == 3 && r.sumDlPoint == 8:
			r.relationshipSymbol = RLL31

		case r.pNum == 4 && r.lNum == 0 && r.maxDlPoint == 3:
			r.relationshipSymbol = RLL11
		case r.pNum == 4 && r.lNum == 0 && r.maxDlPoint == 4 && r.sumDlPoint == 13:
	...
	case matrix.PolygonMatrix:
		...
		case r.pNum == 1 && r.lNum == 0 && r.maxDlPoint == 3 && pointInPolygon == BothPolygon:
			r.relationshipSymbol = RLA8
		case r.pNum == 1 && r.lNum == 0 && r.maxDlPoint == 2 && entityInPolygon == OnlyOutPolygon:
			r.relationshipSymbol = RLA14
		case r.pNum == 1 && r.lNum == 0 && r.maxDlPoint == 2 && entityInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RLA15

			//TODO

		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4 && pointInPolygon == OnlyOutPolygon:
			r.relationshipSymbol = RLA7
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4 && pointInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RLA9
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4 && entityInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RLA22
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4 && entityInPolygon == OnlyOutPolygon:
			r.relationshipSymbol = RLA23
		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 3 && entityInPolygon == OnlyOutPolygon:
...
func (r *Relationship) polygonAnalyse(pointInPolygon, entityInPolygon int) {
	switch r.Arg[1].(type) {
	case matrix.PolygonMatrix:
		switch {
		case r.pNum == 0 && r.lNum >= 1:
			r.relationshipSymbol = RAA9
		case r.pNum >= 2 && r.lNum >= 1 && entityInPolygon == OnlyOutPolygon:
			r.relationshipSymbol = RAA3
		case r.pNum >= 2 && r.lNum >= 1 && entityInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RAA10
		case r.pNum >= 2 && r.lNum >= 1:
			r.relationshipSymbol = RAA11

		case r.pNum == 1 && r.lNum == 0 && entityInPolygon == OnlyOutPolygon:
			r.relationshipSymbol = RAA2
		case r.pNum == 1 && r.lNum == 0 && entityInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RAA8
		case r.pNum == 1 && r.lNum == 0:
			r.relationshipSymbol = RAA7

		case r.pNum == 2 && r.lNum == 0 && r.maxDlPoint == 4:
			r.relationshipSymbol = RAA4

		case r.pNum == 0 && r.lNum == 0 && entityInPolygon == OnlyInPolygon:
			r.relationshipSymbol = RAA6
		case r.pNum == 0 && r.lNum == 0:
