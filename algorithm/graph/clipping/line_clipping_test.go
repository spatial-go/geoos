...
func TestLineClipping_Union(t *testing.T) {
	...
	tests := []struct {
		...
		{"line point0", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.Matrix{100, 100}}}, matrix.LineMatrix{{100, 100}, {100, 101}}, false},
		{"line line0", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.LineMatrix{{100, 100}, {100, 101}}}},
			matrix.LineMatrix{{100, 100}, {100, 101}}, false},
		{"line line1", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.LineMatrix{{100, 100}, {90, 102}}}},
			matrix.Collection{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.LineMatrix{{100, 100}, {90, 102}}}, false},
		{"line poly1", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {101, 101}},
			matrix.PolygonMatrix{{{90, 90}, {90, 101}, {101, 101}, {101, 90}, {90, 90}}},
		}},
			matrix.PolygonMatrix{{{90, 90}, {90, 101}, {101, 101}, {101, 90}, {90, 90}}}, false},
		{"line poly2", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}},
		...
		{"line poly3", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}},
...
func TestLineClipping_Intersection(t *testing.T) {
	...
	tests := []struct {
		...
		{"line point0", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.Matrix{100, 100}}}, matrix.Matrix{100, 100}, false},
		{"line line0", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.LineMatrix{{100, 100}, {100, 101}}}},
			matrix.LineMatrix{{100, 100}, {100, 101}}, false},
		{"line line1", fields{&PointClipping{matrix.LineMatrix{{100, 100}, {100, 101}}, matrix.LineMatrix{{100, 100}, {90, 102}}}},
		...
		{"line poly5", fields{&PointClipping{matrix.LineMatrix{{111.98638916015625, 38.50357937743225}, {111.96372985839844, 38.42723559654225},
...
func TestLineClipping_Difference(t *testing.T) {
	...
	tests := []struct {
		...
		{"line line0", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 50}, {50, 150}}}},
			matrix.LineMatrix{{50, 150}, {50, 200}, {60, 200}}, false},
		{"line line1", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 120}, {50, 150}}}},
			matrix.Collection{matrix.LineMatrix{{50, 100}, {50, 120}}, matrix.LineMatrix{{50, 150}, {50, 200}, {60, 200}}}, false},
		{"line line2", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 150}, {50, 250}}}},
			matrix.Collection{matrix.LineMatrix{{50, 100}, {50, 150}}, matrix.LineMatrix{{50, 200}, {60, 200}}}, false},
		{"line line3", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 100}, {50, 150}}}},
			matrix.LineMatrix{{50, 150}, {50, 200}, {60, 200}}, false},
		{"line line4", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 150}, {50, 200}}}},
			matrix.Collection{matrix.LineMatrix{{50, 100}, {50, 150}}, matrix.LineMatrix{{50, 200}, {60, 200}}}, false},
		{"line line5", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}}, matrix.LineMatrix{{50, 50}, {50, 250}}}},
			matrix.Collection{}, false},
		{"line line6", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{50, 50}, {50, 250}}}},
			matrix.LineMatrix{{50, 200}, {60, 200}}, false},

		{"line line7", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}}, matrix.LineMatrix{{30, 30}, {30, 150}}}},
			matrix.LineMatrix{{50, 100}, {50, 200}}, false},
		{"line line8", fields{&PointClipping{matrix.LineMatrix{{50, 100}, {50, 200}, {60, 200}}, matrix.LineMatrix{{30, 150}, {60, 150}}}},
			matrix.Collection{matrix.LineMatrix{{50, 100}, {50, 150}}, matrix.LineMatrix{{50, 150}, {50, 200}, {60, 200}}}, false},

		{"line poly1", fields{&PointClipping{matrix.LineMatrix{{111.98638916015625, 38.50357937743225}, {111.96372985839844, 38.42723559654225},
			{111.91085815429688, 38.344887442462806}, {111.87309265136717, 38.24680876017446}, {111.84906005859375, 38.15075747130226}},
			matrix.PolygonMatrix{{{112.01248168945312, 38.4519755295767}, {111.7096710205078, 38.39441521865825}, {111.90948486328125, 38.176671418717746},
				{112.01248168945312, 38.4519755295767}}},
		}},
		...
		{name: "line poly6", fields: fields{&PointClipping{matrix.LineMatrix{{200, 300}, {500, 300}, {500, 600}, {800, 900}},
