...
var TestRelateData = []struct {
	...
	{"polyPoly 0f1",
		[]matrix.Steric{
			matrix.PolygonMatrix{{{90, 90}, {101, 90}, {101, 101}, {90, 101}, {90, 90}}},
			matrix.PolygonMatrix{{{100, 100}, {101, 100}, {101, 101}, {100, 101}, {100, 100}}},
		}, "212F11FF2", false},
	{"polyPoly 00f",
	...
	{"polyPoly f1",
		[]matrix.Steric{matrix.PolygonMatrix{{{90, 90}, {90, 101}, {101, 101}, {101, 90}, {90, 90}}},
			matrix.PolygonMatrix{{{100, 100}, {101, 100}, {101, 101}, {100, 101}, {100, 100}}}}, "212F11FF2", false},
	{"lineline f1c",
