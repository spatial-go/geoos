...
func readCollection(r io.Reader, order byteOrder, buf []byte) (geoos.Collection, error) {
	...
	result := make(geoos.Collection, 0, alloc)
...
func (e *Encoder) writeCollection(c geoos.Collection) error {
