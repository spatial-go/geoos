...
var (
	testPoint     = geoos.Point{-117.15906619141342, 32.71628524142945}
	testPointData = []byte{
...
func TestPoint(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			expected: geoos.Point{-122.4546440212, 37.7382859071},
		},
		{
			name:     "big endian",
		...
		},
		{
			...
			expected: geoos.Point{-93.787988, 32.392335},
		},
	}
...
var (
	testMultiPoint     = geoos.MultiPoint{{10, 40}, {40, 30}, {20, 20}, {30, 10}}
	...
	testMultiPointSingle     = geoos.MultiPoint{{10, 40}}
